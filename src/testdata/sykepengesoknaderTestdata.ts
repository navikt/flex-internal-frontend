export const sykepengesoknaderTestdata = {
    sykepengesoknadListe: [
        ...
        {
            id: 'e21022f9-f509-3b29-ae4f-51f47a87f349',
            sykmeldingId: 'bb95fde1-cdc7-4fc9-baee-abc8dccd0dfe',
            soknadstype: 'SELVSTENDIGE_OG_FRILANSERE',
            status: 'NY',
            fom: '2024-09-26',
            tom: '2024-10-02',
            opprettetDato: '2024-10-03T14:09:14.823799',
            sendtTilNAVDato: null,
            sendtTilArbeidsgiverDato: null,
            avbruttDato: null,
            startSykeforlop: '2024-09-26',
            sykmeldingUtskrevet: '2024-09-26T02:00:00',
            sykmeldingSignaturDato: '2024-10-03T14:08:42.633531',
            arbeidsgiver: null,
        ...
        {
            id: 'a3c12f87-4d56-4e89-b123-9f0e8d7c6b45',
            sykmeldingId: null,
        ...
        {
            id: '97f139b5-7123-4c8d-a3fd-7935c3ddf3b1',
            sykmeldingId: 'ce6f0a84-60d2-6e46-a3dc-e923fee9d926',
            soknadstype: 'SELVSTENDIGE_OG_FRILANSERE',
            status: 'NY',
            fom: '2026-05-01',
            tom: '2026-05-20',
            ...
            sendtTilArbeidsgiverDato: null,
            avbruttDato: null,
            startSykeforlop: '2025-09-26',
            sykmeldingUtskrevet: '2025-09-26T02:00:00',
            sykmeldingSignaturDato: '2025-10-03T14:08:42.633531',
            arbeidsgiver: null,
            arbeidsgiverNavn: null,
            arbeidsgiverOrgnummer: null,
            korrigerer: null,
        ...
        // GRADERT søknad
        {
            id: 'soknad-gradert-001',
            sykmeldingId: 'syk-gradert-001',
            soknadstype: 'ARBEIDSTAKERE',
            status: 'SENDT',
            fom: '2025-07-01',
            tom: '2025-07-31',
            opprettetDato: '2025-08-01T10:00:00',
            sendtTilNAVDato: '2025-08-02T10:00:00',
            sendtTilArbeidsgiverDato: '2025-08-02T10:00:00',
            avbruttDato: null,
            startSykeforlop: '2025-07-01',
            sykmeldingUtskrevet: '2025-07-01T02:00:00',
            sykmeldingSignaturDato: null,
            arbeidsgiver: null,
            arbeidsgiverNavn: 'Klonelabben',
            arbeidsgiverOrgnummer: '907670201',
        ...
        // BEHANDLINGSDAGER søknad
        {
            id: 'soknad-behandlingsdager-001',
            sykmeldingId: 'syk-behandlingsdager-001',
            soknadstype: 'BEHANDLINGSDAGER',
            status: 'SENDT',
            fom: '2025-09-01',
            tom: '2025-09-30',
            opprettetDato: '2025-10-01T10:00:00',
            sendtTilNAVDato: '2025-10-02T10:00:00',
            sendtTilArbeidsgiverDato: null,
            avbruttDato: null,
            startSykeforlop: '2025-09-01',
            sykmeldingUtskrevet: '2025-09-01T02:00:00',
            sykmeldingSignaturDato: null,
            arbeidsgiver: null,
            arbeidsgiverNavn: 'Klonelabben',
            arbeidsgiverOrgnummer: '907670201',
        ...
        // REISETILSKUDD søknad
        {
            id: 'soknad-reisetilskudd-001',
            sykmeldingId: 'syk-reisetilskudd-001',
            soknadstype: 'REISETILSKUDD',
            status: 'SENDT',
            fom: '2026-01-05',
            tom: '2026-01-25',
            opprettetDato: '2026-01-26T10:00:00',
            sendtTilNAVDato: '2026-01-27T10:00:00',
            sendtTilArbeidsgiverDato: null,
            avbruttDato: null,
            startSykeforlop: '2026-01-05',
            sykmeldingUtskrevet: '2026-01-05T02:00:00',
            sykmeldingSignaturDato: null,
            arbeidsgiver: null,
            arbeidsgiverNavn: 'Klonelabben',
            arbeidsgiverOrgnummer: '907670201',
        ...
        // GRADERT_REISETILSKUDD søknad
        {
            id: 'soknad-gradert-reisetilskudd-001',
            sykmeldingId: 'syk-reisetilskudd-001',
            soknadstype: 'GRADERT_REISETILSKUDD',
            status: 'SENDT',
            fom: '2026-01-26',
            tom: '2026-02-15',
            opprettetDato: '2026-02-16T10:00:00',
            sendtTilNAVDato: '2026-02-17T10:00:00',
            sendtTilArbeidsgiverDato: null,
            avbruttDato: null,
            startSykeforlop: '2026-01-05',
            sykmeldingUtskrevet: '2026-01-05T02:00:00',
            ...
            soknadPerioder: [
                {
                    ...
                    tom: '2026-02-15',
                    grad: 50,
                    sykmeldingstype: 'GRADERT_REISETILSKUDD',
                },
            ],
            merknaderFraSykmelding: null,
            ventetidSykmeldingUuid: null,
        },
        // ARBEIDSLEDIG søknad (ingen tilknyttet sykmelding)
        {
            id: 'soknad-arbeidsledig-001',
            sykmeldingId: null,
            soknadstype: 'ARBEIDSLEDIG',
            status: 'SENDT',
            fom: '2025-05-01',
            tom: '2025-05-31',
            opprettetDato: '2025-06-01T10:00:00',
            sendtTilNAVDato: '2025-06-02T10:00:00',
            sendtTilArbeidsgiverDato: null,
            avbruttDato: null,
            startSykeforlop: '2025-05-01',
            sykmeldingUtskrevet: null,
            sykmeldingSignaturDato: null,
            arbeidsgiver: null,
            arbeidsgiverNavn: null,
        ...
        // ANNET_ARBEIDSFORHOLD søknad
        {
            id: 'soknad-annet-arbeidsforhold-001',
            sykmeldingId: null,
            soknadstype: 'ANNET_ARBEIDSFORHOLD',
            status: 'SENDT',
            fom: '2025-04-01',
            tom: '2025-04-30',
            opprettetDato: '2025-05-01T10:00:00',
            sendtTilNAVDato: '2025-05-02T10:00:00',
            sendtTilArbeidsgiverDato: null,
            avbruttDato: null,
            startSykeforlop: '2025-04-01',
            sykmeldingUtskrevet: null,
            sykmeldingSignaturDato: null,
            arbeidsgiver: null,
            arbeidsgiverNavn: 'Frilans AS',
            arbeidsgiverOrgnummer: '123456789',
            korrigerer: null,
            korrigertAv: null,
            arbeidssituasjon: 'ANNET_ARBEIDSFORHOLD',
            soknadPerioder: [
                {
                    fom: '2025-04-01',
                    tom: '2025-04-30',
